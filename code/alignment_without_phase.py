...
#    print(segment_nodes)
    ...
    for i in range(len(position)):
        ...
        for j in range(len(position[i])):
            ...
            chunk_id = current_segment_nodes[2]
            sub_chunk_id = current_segment_nodes[3]
            phase = current_segment_nodes[4]
            phase_color = current_segment_nodes[5]
            sh_stem = current_segment_nodes[6]
            sh_stem_sense = current_segment_nodes[7]
            stem = an.to_anunasika(sh_stem)
            sh_morph = current_segment_nodes[8]
            sh_base = current_segment_nodes[9]
            sh_base_sense = current_segment_nodes[10]
            base = an.to_anunasika(sh_base)
            sh_base_morph = current_segment_nodes[11]
            pre_verb = current_segment_nodes[12]
