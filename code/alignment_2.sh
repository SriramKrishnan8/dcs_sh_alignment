...
sh extract_she_analysis.sh ../data/dcs/dcs_sentences.tsv ../data/sh/sh_files/ cgi_file ../data/dcs/dcs_json_wx observations/alignment_2/she_extraction/timed observations/alignment_2/she_extraction/merged observations/alignment_2/she_extraction/missed

# Alignment 2

# Step 1 and 2 - Normalization and Alignment

mkdir -p observations/alignment_2/step_1/aligned_dataset
mkdir -p observations/alignment_2/modifications
mkdir -p observations/alignment_2/step_2/aligned_dataset

STEP_1=observations/alignment_2/step_1
MOD=observations/alignment_2/modifications
STEP_2=observations/alignment_2/step_2

python3 alignment_without_phase.py ../data/dcs/dcs_sentences.tsv ../data/sh/sh_files/ sktgraph ../data/dcs/dcs_json_wx/ $STEP_1/aligned_dataset/ $STEP_1/time_out.tsv $STEP_1/missed.tsv $STEP_1/multiple.tsv $STEP_1/aligned.tsv $STEP_1/parallel.tsv $STEP_1/comp_entries.tsv $STEP_1/pada_entries.tsv $STEP_1/comp_transitions.tsv $STEP_1/pada_transitions.tsv $STEP_1/not_generated.tsv $STEP_1/sh_file_missing.tsv $STEP_1/missed_chunks.tsv $STEP_1/dcs_file_missing.tsv
...
mkdir -p observations/alignment_2/final
mkdir -p observations/alignment_2/final/aligned_dataset/

FINAL=observations/alignment_2/final
